    ...
    <>
      <main className="h-screen w-full banner">
        <div className="flex flex-col justify-center items-center h-screen">
          <div className="bg-white w-96 mt-6 p-4 rounded-lg shadow-lg  space-y-4">
            <div className="flex justify-center items-center space-x-2 flex-col">
              <div>
                <img className="h-20" src={error} alt="error" />
              </div>
              ...
              <h3 className="font-semibold text-gray mt-5">
                Puede ser que la URL haya expirado, o no esté correctamente
                escrita. Por favor, vuelve al inicio.
              </h3>
              <div className="flex justify-center">
                {" "}
                {/* Se agrega un contenedor flex para centrar el botón */}
                <button
